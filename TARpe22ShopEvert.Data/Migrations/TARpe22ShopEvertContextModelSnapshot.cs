...
namespace TARpe22ShopEvert.Data.Migrations
{
    ...
    partial class TARpe22ShopEvertContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TARpe22ShopEvert.Core.Domain.Car", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("TARpe22ShopEvert.Core.Domain.FileToApi", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TARpe22ShopEvert.Core.Domain.FileToDatabase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TARpe22ShopEvert.Core.Domain.RealEstate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TARpe22ShopEvert.Core.Domain.Spaceship", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TARpe22ShopEvert.Core.Domain.FileToApi", b =>
                {
                    b.HasOne("TARpe22ShopEvert.Core.Domain.Car", null)
                        .WithMany("FilesToApiCar")
                        .HasForeignKey("CarId");

                    b.HasOne("TARpe22ShopEvert.Core.Domain.RealEstate", null)
                        .WithMany("FilesToApi")
